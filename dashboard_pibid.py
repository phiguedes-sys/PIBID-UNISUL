...
# ATUALIZADO: Usando TTL de 600 segundos (10 minutos) para atualizar novos forms sozinhos
...
with tab_magazine:
    ...
    pdf_preview_url = pdf_url.replace("/view?usp=sharing", "/preview")
    ...
    html_code = (
        ...
        '<iframe src="' + pdf_preview_url + '" width="100%" height="700px" style="border: none; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" allow="autoplay"></iframe>'
